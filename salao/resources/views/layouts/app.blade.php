...
<body <?= (($_SERVER['REQUEST_URI'] == '/login') ? 'class="bg-gradient-primary"' : 'id="page-to"') ?>">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
        <div class="sidebar-brand-icon">
          <img src="/imagem/arca-prata.png" style="filter: brightness(2);">
        </div>
        <div class="sidebar-brand-text mx-3">Prever Dashboard</div>
      </a>
      ...
      @if(Auth::user()->id_setor== 1 or Auth::user()->id_setor== 2)
      ...
      <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/administrador/cadastra-obituario">Cadastrar</a>
            <a class="collapse-item" href="/administrador/lista-obituario">Listar</a>
          </div>
        </div>
      </li>
      @endif

      @if(Auth::user()->id_setor== 1 or Auth::user()->id_setor== 3)
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Paginas:</h6>
            <a class="collapse-item" href="/administrador/cadastra-noticia">Cadastrar</a>
            <a class="collapse-item" href="/administrador/lista-noticia">Listar</a>
          </div>
        </div>
      </li>
      @endif

      @if(Auth::user()->id_setor== 1 or Auth::user()->id_setor== 4)
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapseTree" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Paginas:</h6>
            <a class="collapse-item" href="/administrador/lista-solicitacoes-parceiros">Lista solicitações</a>
            <a class="collapse-item" href="/administrador/lista-solicitacoes-aprovadas">Listar aprovados</a>
          </div>
        </div>
      </li>
      @endif
      ...
      <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Paginas:</h6>
            <a class="collapse-item" href="/administrador/lista-locais-banners">Lista Locais</a>
          </div>
        </div>
      </li>
      @endif
      ...
      @if(Auth::user()->id_setor== 1 or Auth::user()->id_setor== 5)
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapseSix" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Paginas:</h6>
            <a class="collapse-item" href="/administrador/cadastra-usuarios">Configurar Usuários</a>
          </div>
        </div>
      </li>
      @endif

      @if(Auth::user()->id_setor== 1 or Auth::user()->id_setor==6)
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapseSeven" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Paginas:</h6>
            <a class="collapse-item" href="/administrador/cadastra-ficha-qualificacao">Cadastrar Ficha de Qual.</a>
            <a class="collapse-item" href="/administrador/lista-ficha-qualificacao">Listar Ficha de Qual.</a>
          </div>
        </div>
      </li>
      @endif
...
-->
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="/admin-assets/usuarios/{{Auth::user()->id}}.png" onerror="handleError(this)">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Prever Marília 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Clique em "Sair" para finalizar a sessão com o administrador do website</div>
  ...
  function handleError(image) {
    image.onerror = "";
    image.src = "/admin-assets/usuarios/{{Auth::user()->id}}.jpg";
    return true;
}
</script>
